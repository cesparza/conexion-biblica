...
[25,'¿Qué hizo Fernando cuando su mamá le dijo que se cambiara?','Le dio una patada al sofá y dio un portazo',['Se puso a llorar y se encerró en su cuarto','Se escondió detrás del sofá sin decir nada','Obedeció de una vez y se cambió de ropa'],
   '¿Qué propone la lectura para cuando sientas enojo?','Respirar hondo, orar a Jesús y hablar con tus padres',['Salir a correr hasta que se te pase el enojo','Quedarte callado y no hablar con nadie ese día','Contarlo en la escuela a tus compañeros']],
[26,'¿Qué descubrió Emely al trabajar con Ermenegildo?','Que era buenísimo haciendo trabajos de ciencias y nadie lo sabía',['Que no quería trabajar y le dejaba todo el trabajo a ella','Que copiaba de otros compañeros para sacar buenas notas','Que estaba enfermo y por eso llegaba tarde a la escuela'],
...
[30,'¿En qué texto dice la Biblia que Nabal era un necio?','1 Samuel 25:25',['1 Samuel 15:22','2 Samuel 25:15','1 Reyes 25:5'],
   '¿Qué hizo Nabal cuando David mandó a pedirle comida?','No solo se negó, sino que habló muy groseramente',['Le mandó muy poca comida y se quedó con el resto','Le pidió dinero a cambio de la comida que traía','Le mandó a sus pastores para que hablaran con David'],],
[31,'¿Qué hizo Abigail al enterarse de la grosería de su esposo?','Mandó comida rápidamente a David y ella misma salió a su encuentro',['Escondió a su familia y a sus siervos en el campo','Le reclamó a Nabal delante de todos sus siervos','Avisó al rey Saúl de que David venía armado'],
...
const GEO = [
[8,'¿A qué país fue enviado Unia Api con el misionero?','A un lugar remoto de Papúa Nueva Guinea',['A una ciudad grande de Australia','A una escuela de Estados Unidos','A una isla pequeña de Filipinas']],
