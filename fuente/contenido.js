...
d1: [
  ...
  { t: '🗓️ La primera de tres deportaciones a Babilonia',
    h: '<p>Lo que cuenta Daniel 1:1-2 es la <strong>primera</strong> de tres deportaciones de Judá a Babilonia, no un hecho aislado. <strong>605 a.C.</strong> — tercer año de Joacim: Nabucodonosor sitia Jerusalén, se lleva parte de los utensilios del templo y un grupo de jóvenes nobles, entre ellos Daniel, Ananías, Misael y Azarías (2 Reyes 24:1; Daniel 1:1-2). <strong>597 a.C.</strong> — reinando ya Joaquín, hijo de Joacim, Nabucodonosor vuelve a sitiar Jerusalén; Joaquín se rinde y es llevado cautivo junto con su corte, sus oficiales y miles de personas más, entre ellas el profeta Ezequiel; Nabucodonosor pone en su lugar a Sedequías, tío de Joaquín, como rey vasallo (2 Reyes 24:10-17). <strong>586 a.C.</strong> — Sedequías se rebela contra Babilonia; tras un sitio de año y medio, Jerusalén cae, el templo y la ciudad son destruidos, y la mayoría de la población restante es deportada (2 Reyes 25:1-21; 2 Crónicas 36:17-21). Daniel llega a Babilonia en la primera de las tres, diecinueve años antes de que el templo mismo desapareciera.</p><p><em>Nota: 2 Reyes y 2 Crónicas todavía no tienen texto RV1995 verificado en esta app (solo Daniel 1-6 lo tiene), así que esta sección describe los hechos sin citar palabra por palabra; en cuanto se agregue ese texto se pueden sumar preguntas de completar sobre estos capítulos también.</em></p>' },
