...
d7: [
  ...
  {t:'🎭 Porfirio: el critico pagano que primero aplico Antioco al cuerno pequeño de Daniel 7',h:`<p><strong>La idea de que el cuerno pequeño es Antioco Epifanes no nacio con la erudicion moderna: la propuso por primera vez, hacia el año 270-280 d.C., un filosofo pagano llamado Porfirio</strong>, en el libro doce de su obra "Contra los cristianos". Su objetivo no era exegetico sino polemico: si podia demostrar que Daniel fue escrito DESPUES de los sucesos que narra (durante la crisis macabea del siglo II a.C.) y no antes, como pretendia ser una profecia autentica, entonces Daniel dejaba de ser evidencia a favor del cristianismo.</p><ul style="margin:.4rem 0 .2rem 1.1rem;padding:0"><li>Porfirio tomo la idea de un autor cristiano anterior, Hipolito (m. 236 d.C.), que ya habia identificado a Antioco con el cuerno pequeño de Daniel 8.</li><li>Pero fue Porfirio, no Hipolito, el primero en extender esa misma identificacion tambien al cuerno pequeño de Daniel 7 — y de ahi la extendio ademas a Daniel 11 y 12.</li><li>Ninguna copia de la obra de Porfirio sobrevivio: se ordeno quemarla dos veces en el siglo V. Hoy solo se conoce su argumento por las citas que hizo de el, para refutarlo, el erudito cristiano Jeronimo (340-420 d.C.) en su propio comentario sobre Daniel.</li></ul><div class="highlight-box">El mismo argumento que hoy repiten algunos comentarios biblicos criticos — que Daniel es "profecia despues del hecho" — tiene 1.800 años de antigüedad, y nacio de un opositor declarado del cristianismo, no de un estudio neutral del texto.</div>`},
  ...
  d8: [
    ...
    { t: '🌍 «Durante un tiempo»: por qué Alejandro casó a diez mil soldados con persas', h:
      `<p>Daniel 7:12 dice algo fácil de pasar por alto: a las tres primeras bestias (Babilonia, Medopersia, Grecia), a diferencia de la cuarta, <strong>"se les prolongó la vida durante un tiempo"</strong> después de perder el dominio político. Ese detalle se cumple de forma muy concreta en la historia de Alejandro.</p><p>En un gesto simbólico, Alejandro se casó con la princesa bactriana Roxana y patrocinó con entusiasmo la boda de diez mil de sus soldados griegos con mujeres persas. Fusionó a propósito las civilizaciones babilónica, persa y griega en algo nuevo: la cultura <strong>helenística</strong>, que siguió marcando a Occidente mucho después de que el imperio político de Alejandro dejara de existir.</p><div class="highlight-box">Los reinos caen como poder político en el momento que marca la profecía, pero su huella cultural puede seguir viva "durante un tiempo": eso es justamente lo que Daniel 7:12 anticipó, y lo que Alejandro cumplió a propósito con sus matrimonios masivos.</div>`},
        ...
        { t: '🔢 Policronio y la primera vez que alguien partio las 2.300 tardes y mañanas por la mitad',h:`<p><strong>Partir los 2.300 dias de Daniel 8:14 en dos mitades (1.150) para que combinen con el "tiempo, tiempos y medio tiempo" del cuerno pequeño de Daniel 7 no es un calculo moderno: el primer autor conocido en intentarlo fue Policronio, un interprete sirio del siglo V (374-430 d.C.)</strong> que seguia la lectura de Antioco Epifanes ya propuesta por Porfirio.</p><ul style="margin:.4rem 0 .2rem 1.1rem;padding:0"><li>Policronio queria hacer encajar el periodo de tiempo del capitulo 8 con el del capitulo 7, y para lograrlo dividio 2.300 entre dos.</li><li>Jeronimo, que escribio el comentario cristiano mas influyente sobre Daniel en esa misma epoca, no siguio a Porfirio en los capitulos 2, 7 ni 9 — pero si coincidio con la lectura de Antioco para los capitulos 8 y 11, y le agrego la idea de que Antioco era ademas un simbolo profetico de un "anticristo" todavia futuro.</li></ul><div class="highlight-box">La regla de dia por año que usa este material para leer los 2.300 años literales no es la unica lectura que ha existido en la historia de la iglesia: la lectura literal de "2.300 dias" que algunos comentarios modernos repiten tiene su origen documentado en un interprete del siglo V que ya seguia el marco de Antioco Epifanes.</div>`},
{ t: '📖 Versículo clave',
